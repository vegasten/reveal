...
import { NodeIdAndTreeIndexMaps } from '@cognite/reveal/public/migration/NodeIdAndTreeIndexMaps';
...
jest.mock('@cognite/reveal/utilities/networking/CogniteClientNodeIdAndTreeIndexMapper');

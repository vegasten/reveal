...
const vertexShaderAntialias = glsl(require('@cognite/reveal/glsl/post-processing/fxaa.vert').default);
const fragmentShaderAntialias = glsl(require('@cognite/reveal/glsl/post-processing/fxaa.frag').default);
const passThroughVertexShader = glsl(require('@cognite/reveal/glsl/post-processing/passthrough.vert').default);
const ssaoShader = glsl(require('@cognite/reveal/glsl/post-processing/ssao.frag').default);
const ssaoFinalShader = glsl(require('@cognite/reveal/glsl/post-processing/ssao-final.frag').default);
